...
const NextArrow = ({ onClick }) => {
  return (
    <div
      className="absolute top-1/2 right-[-25px] text-xl transform -translate-y-1/2 z-10 text-customGolden px-3 py-7 cursor-pointer"
      onClick={onClick}
    >
...
const PrevArrow = ({ onClick }) => {
  return (
    <div
      className="absolute top-1/2 left-[-25px] text-xl transform -translate-y-1/2 z-10 text-customGolden px-3 py-7 cursor-pointer"
      onClick={onClick}
    >
      ...
      <div className="w-full md:w-4/5 mx-auto py-8 relative px-5 mb-10">
        ...
        <Slider {...settings}>
          ...
          <div className="p-2 hover:cursor-pointer">
            <div className="border rounded-3xl px-3 py-7 shadow-lg bg-white w-11/12 lg:w-5/6 h-[26vh] flex flex-col justify-between mx-auto">
