...
const VisionMissionValues = () => {
  ...
  const items = [
    ...
    },
    {
      title: "OUR MISSION",
      content:
        "Our company aims to enter the green energy market, by promoting renewable energy together with high quality and affordable services.",
    },
    {
      title: "OUR VALUES",
      content:
        "Our company conducts its business with integrity and is committed to meeting.",
    },
  ];
