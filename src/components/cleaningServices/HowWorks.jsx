...
const content = [
  {
    ...
    icon: <FaTasks className="text-3xl transition-transform duration-300 hover:cursor-pointer hover:scale-110" />,
  },
  {
    id: 2,
    ...
    icon: <FaClipboardList className="text-3xl transition-transform duration-300 hover:cursor-pointer hover:scale-110" />,
  },
  {
    id: 3,
    ...
    icon: <FaRegStar className="text-3xl  transition-transform duration-300 hover:cursor-pointer hover:scale-110" />,
  },
  {
    id: 4,
    ...
    icon: <FaShieldAlt className="text-3xl  transition-transform duration-300 hover:cursor-pointer hover:scale-110" />,
  },
  {
    id: 5,
    ...
    icon: <FaComments className="text-3xl  transition-transform duration-300 hover:cursor-pointer hover:scale-110" />,
  },
  {
    id: 6,
    ...
    icon: <FaTools className="text-3xl transition-transform duration-300 hover:cursor-pointer hover:scale-110" />,
  },
];
          ...
          {content.map((item) => (
            <li key={item.id} className="flex-start group relative flex lg:flex-col">
              <span
                ...
                aria-hidden="true"
              ></span>
              <div className="inline-flex text-customGolden h-12 w-12 shrink-0 items-center justify-center rounded-lg border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-gray-400 group-hover:bg-orange-50">
                {item.icon}
              </div>
