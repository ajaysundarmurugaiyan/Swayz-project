...
const Construction = () => {
  return (
    <div className="bg-black min-h-screen flex flex-col items-center">
      ...
      {/* Row 1 */}
      <div className="flex flex-col md:flex-row w-full max-w-5xl my-10 space-y-20">
        <motion.div
      ...
      {/* Row 3 */}
      <div className="flex flex-col md:flex-row w-full max-w-5xl mt-10 mb-20 space-y-20 ">
        <motion.div
          className="relative w-full md:w-1/2 cursor-pointer md:mr-4"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
