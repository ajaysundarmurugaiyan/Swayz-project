...
const Main1 = () => {
  ...
  return (
    <div className=" md:pb-20 px-5   md:px-20 bg-white text-center">
      <h2 className="text-3xl font-bold text-customGolden">
        Our Construction Process
      </h2>
      <p className="mt-6 text-customGrey font-semibold text-base md:text-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mt-10">
        ...
        >
          ...
          <div className="relative z-10">
            <FaDraftingCompass className="text-5xl text-customGolden mb-4 mx-auto" />
        ...
        <motion.div
          ...
          viewport={{ once: false }}
        >
          <FaTools className="text-5xl text-customGolden mb-4 mx-auto" />
        ...
        >
          <div className="absolute inset-0 bg-black opacity-60"></div>
          <div className="relative z-10">
            <FaBuilding className="text-5xl text-customGolden mb-4 mx-auto" />
        ...
        <motion.div
          ...
          viewport={{ once: false }}
        >
          <FaCheckCircle className="text-5xl text-customGolden mb-4 mx-auto" />
